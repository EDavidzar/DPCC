...
@ActionID(
        category = "File",
        id = "ccpd.es.p8actions.Options"
)
@ActionRegistration(
        iconBase = "ccpd/es/p8actions/opciones.png",
        displayName = "#CTL_Options"
)
@ActionReferences({
    @ActionReference(path = "Menu/File", position = 1650),
    @ActionReference(path = "Toolbars/File", position = 285),
    @ActionReference(path = "Shortcuts", name = "DS-O")
})
@Messages("CTL_Options=Opciones/Personalización")
